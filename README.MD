📋 Información General
Nombre del Proyecto: kafka-cero-a-experto Versión: 0.0.1-SNAPSHOT Grupo: com.jsancue Descripción: Proyecto de Spring Kafka Java Version: 21

🏗️ Arquitectura del Proyecto
Este es un proyecto de Spring Boot enfocado en el aprendizaje y uso de Apache Kafka, que utiliza las siguientes tecnologías:
...
Avro Maven Plugin: Para generar clases Java a partir de esquemas Avro
...
Este proyecto está diseñado como una guía educativa para aprender Apache Kafka desde cero hasta un nivel experto, incluyendo:

Configuración básica de Kafka con Spring Boot
Producción y consumo de mensajes
Uso de Apache Avro para serialización
Integración con Schema Registry de Confluent
